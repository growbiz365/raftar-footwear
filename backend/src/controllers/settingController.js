...
const DEFAULTS = {
  ...
  newsletterPopup: {
    ...
    title: 'ENJOY 10% OFF YOUR FIRST ORDER',
    subtitle: 'Stay Informed! Monthly Tips, Tracks and Discount.',
    image: 'https://raftarfootwear.com/wp-content/uploads/2026/07/hero-image-final.png',
  ...
  salesPopup: {
    ...
    intervalSeconds: 8,
    items: [
      { name: "Women's Buckle Slide", city: 'Peshawar', time: '12 Minutes Ago', img: 'https://raftarfootwear.com/wp-content/uploads/2026/07/article-019-brown.webp' },
      { name: "Men's Cross-Strap Slide", city: 'Lahore', time: '28 Minutes Ago', img: 'https://raftarfootwear.com/wp-content/uploads/2026/07/article-815.webp' },
      { name: 'Massage Flip-Flop', city: 'Karachi', time: '45 Minutes Ago', img: 'https://raftarfootwear.com/wp-content/uploads/2026/07/article-05.webp' },
      { name: "Men's Sports Slide", city: 'Islamabad', time: '1 Hour Ago', img: 'https://raftarfootwear.com/wp-content/uploads/2026/07/article-017.webp' }
    ]
  },
  exitPopup: {
    enabled: false,
